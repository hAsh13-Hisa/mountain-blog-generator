#!/usr/bin/env python3
"""
新しいアフィリエイト特化サイト（static_site_new）をFTPデプロイ
"""
import ftplib
import os
...
LOCAL_DIR = Path('static_site_new')

class NewSiteFTPDeployer:
    def __init__(self):
